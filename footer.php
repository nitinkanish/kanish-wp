...
<footer class="bg-dark pt-5">
	<div class="container">
		...
		<div class="row pt-3 pb-4">
			<div class="col-md-3">
				<img src="<?= home_url() ?>/wp-content/themes/md-blog/assets/images/logo-footer.svg" alt="footer logo">
			</div>
			<div class="col-md-5">
		...
		<div class="row pt-5">
			...
			<div class="col-sm-6 col-lg-3 mb-4">
				...
				<div class="row g-2">
					<div class="col">
						<a href="#"><img class="w-100" src="<?= home_url() ?>/wp-content/themes/md-blog/assets/images/app-store.svg" alt="app-store"></a>
					</div>
					<div class="col">
						<a href="#"><img class="w-100" src="<?= home_url() ?>/wp-content/themes/md-blog/assets/images/google-play.svg" alt="google-play"></a>
					</div>
				</div>
			</div>
		</div>
...
<div class="alert alert-dismissible fade show bg-dark text-white position-fixed start-0 bottom-0 z-index-99 shadow p-4 ms-3 mb-3 col-9 col-md-4 col-lg-3 col-xl-2" role="alert">
  ...
  <div class="mt-4">
	...
	<div class="position-absolute end-0 top-0 mt-n3 me-n3"><img class="w-100" src="<?= home_url() ?>/wp-content/themes/md-blog/assets/images/cookie.svg" alt="cookie"></div>
</div>
<!-- =======================
Cookies alert END -->
